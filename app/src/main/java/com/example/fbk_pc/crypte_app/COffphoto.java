...
public class COffphoto extends AppCompatActivity {
        Activity myactivity;
       Button btn1,button;
   ...
   /* COffphoto(String path) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_coffphoto);
         myactivity=this;
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                properties.root = new File(DialogConfigs.DEFAULT_DIR + "/DCIM");
                properties.error_dir = new File(DialogConfigs.DEFAULT_DIR);
                properties.offset = new File(DialogConfigs.DEFAULT_DIR);
                properties.extensions = new String[]{"jpg"};


                      final FilePickerDialog dialog = new FilePickerDialog(COffphoto.this, properties);
                      dialog.setTitle("Select les photos");
                      dialog.setDialogSelectionListener(new

                      DialogSelectionListener() {
                          public void onSelectedFilePaths (final String[] files){
                              final AlertDialog.Builder builder = new AlertDialog.Builder(COffphoto.this);
                              ...
                              builder.setPositiveButton("yes", new DialogInterface.OnClickListener() {
                                  ...
                                  public void onClick(final DialogInterface dialog, int which) {
                                      final AlertDialog.Builder builder1 = new AlertDialog.Builder(COffphoto.this);
                                      final EditText editText = new EditText(COffphoto.this);
                                      editText.setInputType(InputType.TYPE_CLASS_TEXT | InputType.TYPE_TEXT_VARIATION_PASSWORD);
                                      builder1.setView(editText);
                                      builder1.setTitle("Confirmation");
                                      builder1.setMessage("Entrer votre mot de passe");
                                      builder1.setPositiveButton("Confirmer ", new DialogInterface.OnClickListener() {
                                          ...
                                          public void onClick(DialogInterface dialog, int which) {
                                              ...
                                              if(res==true){
                                                  crupterphoto crypterphoto = new crupterphoto(files, COffphoto.this,sgl);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FilePickerDialog dialog = new FilePickerDialog(COffphoto.this,properties);
                dialog.setTitle("Select les photos");
                    ...
                    public void onSelectedFilePaths( final String[] files) {
                        ...
                        builder1.setPositiveButton("oui", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                boolean res = sgl.user(a);
                                if (res==true) {
                                    decrypterphoto decrypterphoto = new decrypterphoto(files, COffphoto.this, sgl);
    ...
    private class crupterphoto extends AsyncTask<String[],Integer,String>{
        ...
        protected void onPreExecute(){
            super.onPreExecute();
            progressDialog.setTitle("Attender");
            progressDialog.setMessage("Attendez quelques secondes");
     ...
     private class decrypterphoto extends AsyncTask<String [],Integer,String>{
        ...
        protected void onPreExecute(){
            super.onPreExecute();
            progressDialog1.setTitle("Attender");
            progressDialog1.setMessage("Attendez quelques secondes");
