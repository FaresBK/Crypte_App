...
public class Coffvideo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_coffvideo);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FilePickerDialog dialog = new FilePickerDialog(Coffvideo.this,properties);
                dialog.setTitle("Select Video");
                dialog.setDialogSelectionListener(new DialogSelectionListener() {
                    public void onSelectedFilePaths(final String[] files) {
                        final AlertDialog.Builder builder=new AlertDialog.Builder(Coffvideo.this);
                        ...
                        builder.setPositiveButton("yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(final DialogInterface dialog, int which) {
                                final AlertDialog.Builder builder1 = new AlertDialog.Builder(Coffvideo.this);
                                final EditText editText = new EditText(Coffvideo.this);
                                ...
                                builder1.setPositiveButton("confermer ", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        if (res == true) {
                                            crupterphoto crypterphoto = new crupterphoto(files, Coffvideo.this, sgl);
          ...
          button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final FilePickerDialog dialog = new FilePickerDialog(Coffvideo.this,properties);
                    ...
                    public void onSelectedFilePaths(final String[] files) {
                        ...
                        builder1.setPositiveButton("oui", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                boolean res = sgl.user(a);
                                if (res==true) {
                                    decrypterphoto decrypterphoto = new decrypterphoto(files, Coffvideo.this, sgl);
