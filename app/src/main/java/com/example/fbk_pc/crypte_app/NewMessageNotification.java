...
public class NewMessageNotification {
    ...
    private static crypteSms cryptesms;
    ...
    public static void notify(final Context context,
                              final String exampleString,final String Sms,final int number) {
        final Resources res = context.getResources();

        // This image is used as the notification's large icon (thumbnail).
        // TODO: Remove this if your notification has no relevant thumbnail.
        final Bitmap picture = BitmapFactory.decodeResource(res, R.drawable.sms_icon);


        final String ticker = exampleString;
        final String title = res.getString(
                R.string.new_message_notification_title_template, exampleString);
          //String sms=cryptesms.decryptersms(Sms);
        final String text = Sms;
