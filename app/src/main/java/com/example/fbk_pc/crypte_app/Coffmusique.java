...
public class Coffmusique extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_coffmusique);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                properties.root = new File(DialogConfigs.DEFAULT_DIR + "/Music");
                properties.error_dir = new File(DialogConfigs.DEFAULT_DIR);
                properties.offset = new File(DialogConfigs.DEFAULT_DIR);
                properties.extensions = new String[]{"mp3"};

                FilePickerDialog dialog = new FilePickerDialog(Coffmusique.this, properties);
                dialog.setTitle("Select les musiques");
                dialog.setDialogSelectionListener(new DialogSelectionListener() {
                    public void onSelectedFilePaths(final String[] files) {
                        final AlertDialog.Builder builder = new AlertDialog.Builder(Coffmusique.this);
                        ...
                        builder.setPositiveButton("yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(final DialogInterface dialog, int which) {
                                final AlertDialog.Builder builder1 = new AlertDialog.Builder(Coffmusique.this);
                                final EditText editText = new EditText(Coffmusique.this);
                                ...
                                builder1.setPositiveButton("Confirmer ", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        if (res == true) {
                                            crupterphoto crypterphoto = new crupterphoto(files, Coffmusique.this, sgl);
                    ...
                    public void onSelectedFilePaths(final String[] files) {
                        ...
                        builder1.setPositiveButton("oui", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                boolean res = sgl.user(a);
                                if (res==true) {
                                    decrypterphoto decrypterphoto = new decrypterphoto(files, Coffmusique.this, sgl);
